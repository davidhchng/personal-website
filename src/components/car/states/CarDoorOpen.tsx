...
// Front (driver) door swings open — hinge at A-pillar x≈796
export default function CarDoorOpen() {
  return (
    <svg viewBox="0 0 1200 520" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-full" aria-hidden="true">
      ...
      {/* dark interior cavity revealed by open door */}
      <path d="M 578 253 L 796 253 L 828 420 L 578 420 Z" fill="#0A0A0A" />
      {/* seat back */}
      <rect x="615" y="305" width="110" height="68" rx="2" fill="#111" />
      <rect x="615" y="305" width="14" height="68" rx="2" fill="#161616" />
      <rect x="636" y="296" width="62" height="13" rx="3" fill="#131313" />
      {/* dashboard glimpse */}
      <rect x="756" y="266" width="36" height="26" rx="1" fill="#0D0D0D" />

      {/* WINDOWS — rear + windshield only (front door window animates with door) */}
      ...
      <path d="M367 286 L571 286" stroke="#EBEBEB" strokeWidth="2.5" strokeLinecap="round" />
      <path d="M423 253 L567 253" stroke="#EBEBEB" strokeWidth="2.5" strokeLinecap="round" />
      ...
      {/* ── ANIMATED FRONT DOOR — hinge at A-pillar x=796 ─────────────────── */}
      <motion.g
        initial={{ rotateY: 0 }}
        animate={{ rotateY: -44 }}
        transition={{ duration: 0.9, ease: [0.25, 0.46, 0.45, 0.94], delay: 0.12 }}
        style={{ transformOrigin: "796px 353px" }}
      >
        <path d="M 578 287 L 796 287 L 827 419 L 579 420 Z" fill="#F6F6F6" />
        <path d="M 580 286 L 790 286 L 735 253 L 578 253 Z" fill="#0C0D11" />
        <line x1="580" y1="286" x2="795" y2="286" stroke="#EBEBEB" strokeWidth="2" />
        <path d="M 580 347 C 640 344 720 343 795 347" fill="none" stroke="#D5D5D5" strokeWidth="2" strokeLinecap="round" />
        <rect x="690" y="345" width="26" height="7" rx="3.5" fill="#C0C0C0" />
      </motion.g>
    </svg>
  );
